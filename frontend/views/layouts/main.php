                                                ...
                                                <div class="control">
                                                    <label class="checkbox checkbox--primary ">
                                                        ...
                                                        <span class="checkbox__text">Нажимая «Отправить» , Вы соглашаетесь с <a
                                                                    href="/docs/privacy-policy.pdf" target="_blank" class="">Политикой конфиденциальности</a> и <a
                                                                    href="/docs/terms-of-use.pdf" target="_blank" class="">обработкой персональных данных</a></span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="control">
                                                    <label class="checkbox checkbox--primary ">
                                                        ...
                                                        <span class="checkbox__text">Нажимая «Отправить» , Вы соглашаетесь с
                                                            <a href="/docs/privacy-policy.pdf" target="_blank" class="">Политикой конфиденциальности</a> и
                                                            <a href="/docs/terms-of-use.pdf" target="_blank" class="">обработкой персональных данных</a>
                                                        </span>
                                                    </label>
                                                </div>
                                            </div>
